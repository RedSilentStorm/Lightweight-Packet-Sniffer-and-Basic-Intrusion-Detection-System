...
APP_SRC = src/packet_ids_cli.c src/ids_tracker.c src/alert_logger.c src/parse_utils.c src/packet_parser.c src/capture_source.c
...
IDS_RULE_DEMO_SRC = src/ids_live_rule_demo.c src/ids_tracker.c src/alert_logger.c src/parse_utils.c
...
REPLAY_DEMO_SRC = src/ids_live_or_pcap.c src/ids_tracker.c src/alert_logger.c src/parse_utils.c src/packet_parser.c src/capture_source.c
